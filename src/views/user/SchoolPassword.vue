...
<script>
  ...
  export default {
    ...
    created(){
      this.getUserInfo();
      console.log("schoolUser="+this.$store.state.schoolUser.userId  )
    },
    methods: {
      getUserInfo(){
        this.ruleForm.schoolUserId=this.$store.state.schoolUser.userId
        console.log("this.ruleForm.schoolUserId="+this.ruleForm.schoolUserId);
        this.api({
          url: "/user/getSchoolUserInfo",
          method: "post",
          data: this.ruleForm
        }).then((res) => {
      ...
      submitForm1(){
        this.ruleForm1.schoolUserId=this.$store.state.schoolUser.userId
        this.api({
          url: "/user/updateSchoolUserInfo",
          method: "post",
          data: this.ruleForm1
        }).then((res) => {
          this.$message({
