<template>
  <div class="app-container">
    ...
    <el-table :data="list"
      ...
      <el-table-column align="center" label="申请学校" width="120">
        <template slot-scope="scope">
...
<script>
  ...
  export default {
    ...
    created() {
      console.log("进入到了Processed_____开始查询管理员权限和列表信息")
      this.getList();
    },
    methods: {
      blackApply(id){
        ...
        this.$confirm('确定加入黑名单?', '提示', {
          ...
          _vue.api({
            url: "/scholat/apply/blackApplySchool",
            method: "post",
            data: {
              "apply_id":id
            }
      ...
      allowApply(id) {
        ...
        this.$confirm('确定?', '提示', {
          ...
          this.$message.warning("申请的id是:" + id)
          _vue.api({
            url: "/scholat/apply/allowApplySchool",
            method: "post",
            data: {
              "apply_id": id
            }
