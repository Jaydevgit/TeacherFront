  ...
  <div>
    ...
    <div class="apply-container">
      ...
      <el-form
        ...
        <div class="apply-title">学校管理员申请</div>
        <el-steps :active="active" align-center>
          <el-step title="步骤1" description="填写学校信息"></el-step>
          <el-step title="步骤2" description="填写管理员信息"></el-step>
          <el-step title="步骤3" description="注册成功"></el-step>
        </el-steps>
        <div v-show="active===0">
          <div class="top-title">学校信息</div>
          <div class="top">
            ...
            <div class="form-domain-name">
              <el-form-item prop="domain_name" label="学院域名设置：">
                ...
                &lt;!&ndash;              <div style="position: absolute;top:30px;color: red;font-size:12px;">学院英文简写，用作域名，申请成功后不可修改</div>&ndash;&gt;
              </el-form-item>
            </div>-->
    ...
    data() {
            ...
            if (!pattern.test(value)) {
              ...
              this.api({
                ...
                if (res.UserName === true) {
                  console.log("该用户名已注册");
                  _self.ifSchoolDomainExist = false;
                  return callback(new Error("该用户名已注册"));
                } else {
                  _self.ifSchoolDomainExist = true;
                  return callback();
                }
              }).catch();
            }
      ...
      let validatorSchoolDomain=(rule, value, callback) => {
        ...
        if (!pattern.test(value)) {
          ...
          this.api({
            url: '/register/judgeSchoolDomainNameExist',
            method: 'post',
            data: {
              "school_domain": value
            }
            ...
            if (res.existSchoolDomainName === true) {
              console.log("该域名已注册");
              _self.ifSchoolDomainExist = false;
    ...
    methods: {
      ...
      submitForm() {
        ...
        this.api({
          ...
          } else if (data.existSchoolDomainName != null) {
      ...
      next() {
        ...
        console.log("ifSchoolDomainExist="+JSON.stringify(this.ifSchoolDomainExist));
      ...
      //上传所需文件提示框
      reminder() {
        this.$alert('<span><strong>1:身份证正反面照片</strong></span><br/><span><strong>2:在职证明文件照片</strong></span><br/><br/><span style="color: red"><strong>注意： 这是公共账号，一个学校只能申请一次</strong></span>', '注册所需准备文件', {
