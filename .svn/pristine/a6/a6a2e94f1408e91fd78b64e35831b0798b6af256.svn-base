<template>
  <div id="page">
    <div id="fansWorkDistribution_echarts" style="height: calc(100% - 45px);width: 100%;">
...
<script>
    ...
    export default {
        name: "fans_workDistribution.vue",
        data() {
            return {
        ...
        mounted() {
            ...
            Array.from(this.fans).forEach((v, k) => {
        ...
        methods: {
            initECharts() {
                var dom = document.getElementById("fansWorkDistribution_echarts");
                var fansChart = echarts.init(dom);
                var app = {};
