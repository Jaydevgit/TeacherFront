<template>
  <div id="page">
    <div id="friendsWorkDistribution_echarts" style="height: calc(100% - 45px);width: 100%;">
...
<script>
    ...
    export default {
        name: "friends_workDistribution.vue",
        data() {
            return {
        ...
        mounted() {
            ...
            Array.from(this.friends).forEach((v, k) => {
        ...
        methods: {
            initECharts() {
                var dom = document.getElementById("friendsWorkDistribution_echarts");
